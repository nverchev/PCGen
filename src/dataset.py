...
class Modelnet40Dataset:
    ...
    def __init__(self, dir_path, cov_matrix, num_points, val_every=6, **augmentation_settings):
...
class ShapeNetDataset:
    ...
    def __init__(self, dir_path, cov_matrix, num_points, **augmentation_settings):
        self.dir_path = dir_path
