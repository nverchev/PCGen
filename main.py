...
def parse_args():
    ...
    parser.add_argument('--encoder', type=str, default='DGCNN_sim', choices=["MLP", "DGCNN_sim", "DGCNN", "PCT"])
    parser.add_argument('--decoder', type=str, default='MLP', choices=["MLP", "Gen", "FoldingNet"])
