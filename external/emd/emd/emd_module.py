...
class emdFunction(Function):
    ...
    def forward(ctx, xyz1, xyz2, eps, iters):
        ...
        emd_backend.forward(xyz1, xyz2, dist, assignment, price, assignment_inv, bid, bid_increments, max_increments, unass_idx,
    ...
    def backward(ctx, graddist, gradidx):
        ...
        emd_backend.backward(xyz1, xyz2, gradxyz1, graddist, assignment)
